...
<head>
  ...
  <title>PRA System | Admin Dashboard</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link btn-light" data-widget="" href="{{url('/user-logout')}}" role="button">
        Log Out
        </a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{url('/admin')}}" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Paul Ratnayake Associates</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="dist/img/usernew1.jpeg" class="img-circle elevation-2" alt="usernew1">
        </div>
        <div class="info">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="#" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Case List Details</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('admin-caselist')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Case</p>
                </a>
              </li>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy;Hansani Seneviratne|</strong>
    All rights reserved.
